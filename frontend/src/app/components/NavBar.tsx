    ...
    <div className="navbar rounded-box bg-gray-100 glass">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul
            tabIndex={0}
            className="menu menu-md dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-96"
          >
            <li>
              <Link href="/">Home</Link>
            </li>
      ...
      <div className="navbar-end">
        <button className="btn btn-neutral hidden lg:block">Contact us</button>
      </div>
    </div>
