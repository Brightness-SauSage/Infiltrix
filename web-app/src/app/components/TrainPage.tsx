...
export default function MainPage () {
    ...
    <div className="container flex justify-center items-center">
        <div className="relative"> 
          ...
          <input type="text" className="inter font-light text-base border border-gray-300 h-12 w-96 pl-6 pr-20 md:h-12 md:w-96 md:pl-6 md:pr-20 rounded-full z-0 focus:shadow focus:outline-none" placeholder="paste your message here" />
...
<div className="mt-8 h-96 w-screen" style={{ background: 'linear-gradient(70deg, #a855f7, #ec4899)' }}></div>
